			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            ...
		            while (true) {
		                ...
		                switch (tokens) {
		                    case ERROR:
		                        resultado += lexer.lexeme+": Identificador no permitido\n";
		                        break;
		                    case ERROR2:
		                        resultado += "Simbolo no definido, verifique los datos\n";
		                        break;
		                   case Identificador: 
		                	   resultado += lexer.lexeme + ": Es un Identificador permitido\n";
		                	   break;
		                   case Numero: case Reservadas:
